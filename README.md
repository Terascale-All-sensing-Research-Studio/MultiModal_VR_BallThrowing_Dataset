...
|--|--|--|--|
| [capturetimedata](/capturetimedata) | None | CSV | capturetimedata.csv: A CSV file that provides the temporal difference (in days) between successive sessions for each of the 41 participants. |
